...
def menu():
  ...
  print (' [9] View Results Crack')
  print (' [A] Account Checker')
  print (' [0] Delete Cookies\n')
  mn = raw_input(" [*] Input : ")
  if mn == "":
...
def metode():
    print ('\n [1] Method Crack mbasic.facebook.com Fast')
    print (' [2] Method Crack m.facebook.com Slow')
    print (' [3] Method Crack free.facebook.com Slow ')
    print (' [4] Method Crack group.facebook.com Slow')
    md = raw_input(' [*] Input : ')
    if md == '':
        os.sys.exit()
    elif md == '1' or md == '01':
